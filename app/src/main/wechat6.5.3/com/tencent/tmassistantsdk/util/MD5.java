...
public class MD5 {
    ...
    protected final byte[] digest = new byte[S33];
    ...
    private void md5Transform(byte[] bArr) {
        ...
        long FF9 = FF(FF7, j2, FF4, FF8, jArr[S32], 22, 2304563134L);
        long FF10 = FF(FF8, FF9, j2, FF4, jArr[S12], 7, 1804603682);
        FF7 = FF(FF4, FF10, FF9, j2, jArr[13], 12, 4254626195L);
        j2 = FF(j2, FF7, FF10, FF9, jArr[S23], 17, 2792965006L);
        FF3 = FF(FF9, j2, FF7, FF10, jArr[S43], 22, 1236535329);
        FF10 = GG(FF10, FF3, j2, FF7, jArr[1], 5, 4129170786L);
        j3 = GG(FF7, FF10, FF3, j2, jArr[6], 9, 3225465664L);
        FF2 = GG(j2, j3, FF10, FF3, jArr[S32], 14, 643717713);
        ...
        long GG = GG(FF2, FF, j4, FF9, jArr[S43], 14, 3634488961L);
        FF3 = GG(FF9, GG, FF, j4, jArr[4], 20, 3889429448L);
        FF6 = GG(j4, FF3, GG, FF, jArr[9], 5, 568446438);
        long GG2 = GG(FF, FF6, FF3, GG, jArr[S23], 9, 3275163606L);
        ...
        long GG4 = GG(FF5, FF4, FF, GG3, jArr[S12], 20, 2368359562L);
        FF6 = HH(GG3, GG4, FF4, FF, jArr[5], 4, 4294588738L);
        FF8 = HH(FF, FF6, GG4, FF4, jArr[8], 11, 2272392833L);
        long HH = HH(FF4, FF8, FF6, GG4, jArr[S32], 16, 1839030562);
        FF5 = HH(GG4, HH, FF8, FF6, jArr[S23], 23, 4259657740L);
        ...
        GG = HH(FF8, FF7, HH4, FF9, jArr[S12], 11, 3873151461L);
        long HH5 = HH(FF9, GG, FF7, HH4, jArr[S43], 16, 530742520);
        ...
        FF9 = II(HH5, II, GG2, FF10, jArr[S23], 15, 2878612391L);
        GG3 = II(FF10, FF9, II, GG2, jArr[5], 21, 4237533241L);
        long II2 = II(GG2, GG3, FF9, II, jArr[S12], 6, 1700485571);
        ...
        HH = II(GG, GG2, II3, GG4, jArr[S43], 10, 4264355552L);
        ...
        long II5 = II(HH, HH2, GG3, II4, jArr[S32], 10, 3174756917L);
    ...
    private void Encode(byte[] bArr, long[] jArr, int i) {
        ...
        while (i2 < i) {
            ...
            bArr[i2 + 2] = (byte) ((int) ((jArr[i3] >>> S33) & 255));
    ...
    private void Decode(long[] jArr, byte[] bArr, int i) {
        ...
        int i3 = 0;
        while (i2 < i) {
            jArr[i3] = ((b2iu(bArr[i2]) | (b2iu(bArr[i2 + 1]) << 8)) | (b2iu(bArr[i2 + 2]) << S33)) | (b2iu(bArr[i2 + 3]) << 24);
            i3++;
            i2 += 4;
        }
    }
    ...
    public static String byteHEX(byte b) {
        ...
        return new String(new char[]{cArr[(b >>> 4) & S43], cArr[b & S43]});
    }
    ...
    public static String convertHashToString(byte[] bArr) {
        ...
        String str = "";
        for (byte b : bArr) {
            str = str + Integer.toString((b & 255) + 256, S33).substring(1);
        }
