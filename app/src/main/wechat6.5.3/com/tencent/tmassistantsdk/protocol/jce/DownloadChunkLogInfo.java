...
public final class DownloadChunkLogInfo extends JceStruct implements Cloneable {
    static final /* synthetic */ boolean $assertionsDisabled = (!DownloadChunkLogInfo.class.desiredAssertionStatus() ? true : $assertionsDisabled);
    ...
    public final void readFrom(JceInputStream jceInputStream) {
        this.UUID = jceInputStream.readString(0, $assertionsDisabled);
        this.type = jceInputStream.read(this.type, 1, (boolean) $assertionsDisabled);
        this.requestUrl = jceInputStream.readString(2, $assertionsDisabled);
        this.networkOperator = jceInputStream.readString(3, $assertionsDisabled);
        this.networkType = jceInputStream.read(this.networkType, 4, (boolean) $assertionsDisabled);
        this.isWap = jceInputStream.read(this.isWap, 5, (boolean) $assertionsDisabled);
        this.requestRanagePosition = jceInputStream.read(this.requestRanagePosition, 6, (boolean) $assertionsDisabled);
        this.requestRanageSize = jceInputStream.read(this.requestRanageSize, 7, (boolean) $assertionsDisabled);
        this.responseRangePosition = jceInputStream.read(this.responseRangePosition, 9, (boolean) $assertionsDisabled);
        this.responseRangeLength = jceInputStream.read(this.responseRangeLength, 10, (boolean) $assertionsDisabled);
        this.responseContentLength = jceInputStream.read(this.responseContentLength, 11, (boolean) $assertionsDisabled);
        this.responseHttpCode = jceInputStream.read(this.responseHttpCode, 12, (boolean) $assertionsDisabled);
        this.receiveDataSize = jceInputStream.read(this.receiveDataSize, 13, (boolean) $assertionsDisabled);
        this.startTime = jceInputStream.read(this.startTime, 14, (boolean) $assertionsDisabled);
        this.readHeaderTime = jceInputStream.read(this.readHeaderTime, 15, (boolean) $assertionsDisabled);
        this.endTime = jceInputStream.read(this.endTime, 16, (boolean) $assertionsDisabled);
        this.errorCode = jceInputStream.read(this.errorCode, 17, (boolean) $assertionsDisabled);
        this.resultState = jceInputStream.read(this.resultState, 18, (boolean) $assertionsDisabled);
        this.currentRetryCnt = jceInputStream.read(this.currentRetryCnt, 19, (boolean) $assertionsDisabled);
        this.via = jceInputStream.readString(20, $assertionsDisabled);
        this.appId = jceInputStream.readString(21, $assertionsDisabled);
        this.flag = jceInputStream.readString(22, $assertionsDisabled);
    }
    ...
    public final void displaySimple(StringBuilder stringBuilder, int i) {
        ...
        jceDisplayer.displaySimple(this.flag, (boolean) $assertionsDisabled);
    }
}
