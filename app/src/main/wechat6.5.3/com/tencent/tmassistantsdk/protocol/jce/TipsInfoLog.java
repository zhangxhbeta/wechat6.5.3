...
public final class TipsInfoLog extends JceStruct implements Cloneable {
    static final /* synthetic */ boolean $assertionsDisabled = (!TipsInfoLog.class.desiredAssertionStatus() ? true : $assertionsDisabled);
    ...
    public final void readFrom(JceInputStream jceInputStream) {
        this.userId = jceInputStream.readString(0, $assertionsDisabled);
        this.userIdType = jceInputStream.readString(1, $assertionsDisabled);
        this.gamePackageName = jceInputStream.readString(2, $assertionsDisabled);
        this.gameVersionCode = jceInputStream.read(this.gameVersionCode, 3, (boolean) $assertionsDisabled);
        this.gameChannelId = jceInputStream.readString(4, $assertionsDisabled);
        this.authorizedTipsCount = jceInputStream.read(this.authorizedTipsCount, 5, (boolean) $assertionsDisabled);
        this.downloadTipsCount = jceInputStream.read(this.downloadTipsCount, 6, (boolean) $assertionsDisabled);
        this.installTipsCount = jceInputStream.read(this.installTipsCount, 7, (boolean) $assertionsDisabled);
        this.networkErrorTipsCount = jceInputStream.read(this.networkErrorTipsCount, 8, (boolean) $assertionsDisabled);
        this.cancelBtnClickCount = jceInputStream.read(this.cancelBtnClickCount, 9, (boolean) $assertionsDisabled);
        this.downloadBtnClickCount = jceInputStream.read(this.downloadBtnClickCount, 10, (boolean) $assertionsDisabled);
        this.installBtnClickCount = jceInputStream.read(this.installBtnClickCount, 11, (boolean) $assertionsDisabled);
        this.authorizedBtnClickCount = jceInputStream.read(this.authorizedBtnClickCount, 12, (boolean) $assertionsDisabled);
    }
    ...
    public final void displaySimple(StringBuilder stringBuilder, int i) {
        ...
        jceDisplayer.displaySimple(this.authorizedBtnClickCount, (boolean) $assertionsDisabled);
    }
}
