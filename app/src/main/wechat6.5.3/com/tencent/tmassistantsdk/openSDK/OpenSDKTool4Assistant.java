...
public class OpenSDKTool4Assistant {
    ...
    public static String encryptUri(String str) {
        return Base64.encodeToString(ProtocolPackage.encrypt(str.getBytes(), CRYPT_KEY.getBytes()), 0);
    }

    public static String decryptUri(String str) {
        return new String(ProtocolPackage.decrypt(Base64.decode(str, 0), CRYPT_KEY.getBytes()));
    }
}
