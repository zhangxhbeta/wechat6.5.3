...
public class SightVideoJNI {
    ...
    public static native int initDataBufferForMMSight(int i, int i2, int i3, int i4, int i5, float f, int i6, int i7, int i8, int i9, float f2, boolean z, boolean z2, int i10);
    ...
    public static native int muxing(int i, String str, int i2, int i3, int i4, int i5, long j, String str2, float f, int i6, int i7, int i8, int i9, int i10, float f2, byte[] bArr, int i11);
    ...
    public static native int remuxing(String str, String str2, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, byte[] bArr, int i7);
    ...
    public static int initDataBufferRef(int i, int i2, int i3, int i4, int i5, int i6, int i7, float f, int i8, int i9, int i10, int i11, float f2, int i12) {
        v.d(TAG, "ashutest::call initDataBuffer, ret %d", Integer.valueOf(initDataBuffer(i, i2, i3, i4, i5, i6, i7, f, i8, i9, i10, i11, f2, i12)));
        return initDataBuffer(i, i2, i3, i4, i5, i6, i7, f, i8, i9, i10, i11, f2, i12);
    }

    public static void releaseRecorderBufferRef(String str) {
        v.d(TAG, "ashutest::call release recorder buffer, %s", str);
        releaseRecorderBuffer();
    }

    public static void releaseDataBufferRef(int i) {
        v.d(TAG, "ashutest::call release dataBufferRef %d", Integer.valueOf(i));
        releaseDataBuffer(i);
    }
    ...
    public static void tagMp4RecordInfo(String str, String str2) {
        if (!be.kS(str) && !be.kS(str2)) {
            ...
            v.i(TAG, "tagMP4RecordInfo used %sms", Long.valueOf(be.az(Nj)));
        }
    }
    ...
    public static String getMp4RecordInfo(String str) {
        ...
        if (mP4RecordInfo != null && mP4RecordInfo.length > 0) {
            ...
            i = 0;
            v.i(TAG, "getMp4RecordInfo, index: %s", Integer.valueOf(i));
    ...
    public static void tagMP4Dscp(String str, byte[] bArr) {
        if (!be.kS(str) && bArr != null) {
            ...
            v.i(TAG, "tagMP4Dscp used %sms", Long.valueOf(be.az(Nj)));
        }
    }
}
