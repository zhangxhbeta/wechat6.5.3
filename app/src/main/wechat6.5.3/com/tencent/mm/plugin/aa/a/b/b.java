...
public final class b extends f<a> {
    public static final String[] cic = new String[]{f.a(a.chq, "AAPayRecord")};
    private static final String[] dsX = new String[]{"*", "rowid"};
    private d cie;

    public final com.tencent.mm.plugin.aa.a.b.a md(java.lang.String r9) {
...
*/
    ...
    L_0x0024:
        ...
        if (r0 != 0) goto L_0x0039;	 Catch:{ Exception -> 0x003f, all -> 0x0059 }
    L_0x002a:
        r0 = new com.tencent.mm.plugin.aa.a.b.a;	 Catch:{ Exception -> 0x003f, all -> 0x0059 }
    ...
    L_0x003f:
        r0 = move-exception;
        r2 = "MicroMsg.AAPayRecordStorage";	 Catch:{ Exception -> 0x003f, all -> 0x0059 }
        r3 = "getByPayMsgId error: %s";	 Catch:{ Exception -> 0x003f, all -> 0x0059 }
    ...
    L_0x005f:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.aa.a.b.b.md(java.lang.String):com.tencent.mm.plugin.aa.a.b.a");
    }

    public b(d dVar) {
        super(dVar, a.chq, "AAPayRecord", null);
        this.cie = dVar;
    }
}
