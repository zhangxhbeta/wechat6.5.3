...
public final class n implements a, b {
    ...
    static class AnonymousClass2 extends ac {
        ...
        public final void handleMessage(Message message) {
            ...
            com_tencent_mm_protocal_c_amv.mau = 1048576;
    ...
    public final boolean pz(String str) {
        ...
        if (str.equals("contact_info_voip_sound_notify")) {
            ...
            ak.yW();
            c.vf().set(73217, Boolean.valueOf(isChecked));
            return true;
        } else if (str.equals("contact_info_voip_install")) {
            f(this.context, true);
            return true;
        } else if (str.equals("contact_info_voip_uninstall")) {
    ...
    public final boolean a(f fVar, u uVar, boolean z, int i) {
        ...
        Assert.assertTrue(m.eU(uVar.field_username));
        ak.yW();
        c.vf().a(this);
        this.euW = uVar;
        this.dxf = fVar;
    ...
    private void XR() {
        ...
        this.dxf.removeAll();
        this.dxf.addPreferencesFromResource(2131099686);
        ((HelperHeaderPreference) this.dxf.Ow("contact_info_header_helper")).a(this.euW, this.hWi);
        ((CheckBoxPreference) this.dxf.Ow("contact_info_voip_sound_notify")).ocf = aGN;
        if (obj != null) {
            this.dxf.Ox("contact_info_voip_install");
            return;
        }
        this.dxf.Ox("contact_info_voip_uninstall");
        this.dxf.Ox("contact_info_voip_sound_notify");
    }
    ...
    public final void a(int i, com.tencent.mm.sdk.h.j jVar, Object obj) {
        int n = be.n(obj, 0);
        v.d("MicroMsg.ContactWidgetVoip", "onNotifyChange event:%d obj:%d stg:%s", new Object[]{Integer.valueOf(i), Integer.valueOf(n), jVar});
        ak.yW();
        if (jVar != c.vf() || n <= 0) {
            v.e("MicroMsg.ContactWidgetVoip", "onNotifyChange error obj:%d stg:%s", new Object[]{Integer.valueOf(n), jVar});
