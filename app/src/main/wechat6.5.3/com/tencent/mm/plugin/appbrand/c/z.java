...
public final class z implements d {
    ...
    public final boolean a(f fVar, Canvas canvas, JSONArray jSONArray) {
        ...
        if ("linear".equalsIgnoreCase(optString)) {
            ...
            fVar.dCm.setShader(new LinearGradient((float) a, (float) a2, (float) a3, (float) a4, iArr, fArr, TileMode.CLAMP));
            ...
            a = d.a(optJSONArray, 1);
            a2 = d.a(optJSONArray, 2);
            a3 = d.a(optJSONArray, 3);
            ...
            fVar.dCm.setShader(new RadialGradient((float) a, (float) a2, (float) a3, iArr2, fArr2, TileMode.CLAMP));
        } else if ("normal".equalsIgnoreCase(optString)) {
            optJSONArray = jSONArray.optJSONArray(1);
            if (optJSONArray == null || optJSONArray.length() < 4) {
                return false;
            }
            fVar.dCm.setColor(d.h(optJSONArray));
        }
        return true;
    }
}
