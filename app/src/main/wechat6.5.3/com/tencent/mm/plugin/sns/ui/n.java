...
public final class n implements w {
    ...
    public final boolean a(int i, int i2, b.a.d.i iVar, String str, List<String> list, agp com_tencent_mm_protocal_c_agp, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        ...
        } else if (!(be.kS(this.jEW) || com.tencent.mm.ae.n.GG() == null)) {
        ...
        if (!z2) {
            v.i("MicroMsg.EmojiShareWidget", "set userData user imgurl ");
            z2 = auVar.a(this.jEW, this.jEW, this.jFf, this.jFd, this.jFe);
        }
        if (!z2) {
            v.e("MicroMsg.EmojiShareWidget", "set userData faild");
        }
        auVar.qo(this.jEZ);
        auVar.AO(this.bnR);
        auVar.AP(this.jEY);
        ...
        ad.aSA().aTe();
        this.aWn.finish();
        String ro = j.a.bmr().ro(this.jFe);
        g.iuh.h(10993, new Object[]{Integer.valueOf(1), ro});
        return false;
    }
