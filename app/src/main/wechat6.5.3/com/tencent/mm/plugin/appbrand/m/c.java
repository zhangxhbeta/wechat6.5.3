...
public final class c extends com.tencent.mm.ui.f.c {
    private Comparator<h> cWO = new m();
    ...
    protected final l a(ac acVar, HashSet<String> hashSet) {
        return p.d(this.bkC, this.cWO, this, acVar, hashSet);
    }
    ...
    protected final void a(List<h> list, HashSet<String> hashSet) {
        ...
        v.i("MicroMsg.FTSWeAppDetailUIUnit", "report oreh LocalSearchWeApp(13963), %s", new Object[]{cVar.JH()});
