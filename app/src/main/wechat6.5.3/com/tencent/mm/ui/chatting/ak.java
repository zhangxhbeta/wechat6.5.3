...
final class ak extends b {
    ...
    public final View a(LayoutInflater layoutInflater, View view) {
        ...
        view = new bd(layoutInflater, 2130903317);
        view.setTag(new f(this.eKg).n(view, true));
        return view;
    }
            ...
            case MMGIFException.D_GIF_ERR_NOT_GIF_FILE /*103*/:
                ...
                if (str != null) {
                    ...
                    if (aVar2 != null) {
                        switch (aVar2.type) {
                            case 16:
                                com.tencent.mm.sdk.c.b gyVar = new gy();
    ...
    public final boolean a(View view, a aVar, at atVar) {
        ...
        switch (dV.type) {
            case 16:
                ...
                c.b(aVar.nDR.nEl, "card", ".ui.CardDetailUI", intent);
                return true;
            case 34:
                intent = new Intent();
                ...
                c.b(aVar.nDR.nEl, "card", ".ui.CardGiftAcceptUI", intent);
                return true;
            default:
                return false;
        }
