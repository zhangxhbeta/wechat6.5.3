...
public final class ajp extends aqp {
    public are meT;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            ajp com_tencent_mm_protocal_c_ajp = (ajp) objArr[1];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_ajp.mPU = enVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_ajp.meT = com_tencent_mm_protocal_c_are;
                    }
                    return 0;
                default:
                    return -1;
