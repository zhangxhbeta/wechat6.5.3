...
public final class avs extends aqp {
    public avn mSD;
    public arf mSE;
    public String mbN;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_avs.mPU = enVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_avs.mbN = aVar3.pMj.readString();
                    return 0;
                case 4:
                    zQ = aVar3.zQ(intValue);
                    size = zQ.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_avs.mSE = com_tencent_mm_protocal_c_arf;
                    }
                    return 0;
                default:
                    return -1;
