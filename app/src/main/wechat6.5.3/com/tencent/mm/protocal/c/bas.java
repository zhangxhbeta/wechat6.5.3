...
public final class bas extends aqx {
    public aot mhP;
    public ra moz;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            bas com_tencent_mm_protocal_c_bas = (bas) objArr[1];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bas.mQl = eoVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bas.mhP = eoVar;
                    }
                    return 0;
                case 3:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bas.moz = eoVar;
                    }
                    return 0;
                default:
                    return -1;
