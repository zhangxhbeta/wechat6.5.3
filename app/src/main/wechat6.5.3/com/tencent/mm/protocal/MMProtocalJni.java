...
public final class MMProtocalJni {
    ...
    public static native void genClientCheckKVRes(int i, String str, byte[] bArr, byte[] bArr2, byte[] bArr3, PByteArray pByteArray);
    ...
    public static native boolean pack(byte[] bArr, PByteArray pByteArray, byte[] bArr2, byte[] bArr3, String str, int i, int i2, int i3, byte[] bArr4, byte[] bArr5, byte[] bArr6, boolean z);

    public static native boolean packDoubleHybrid(PByteArray pByteArray, byte[] bArr, String str, int i, int i2, int i3, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, boolean z);

    public static native boolean packHybrid(PByteArray pByteArray, byte[] bArr, String str, int i, int i2, int i3, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, boolean z);
    ...
    public static native boolean unpack(PByteArray pByteArray, byte[] bArr, byte[] bArr2, PByteArray pByteArray2, PInt pInt, PInt pInt2);
