...
public final class aph extends aqx {
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            aph com_tencent_mm_protocal_c_aph = (aph) objArr[1];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aph.mOR = com_tencent_mm_protocal_c_api;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_aph.mOU = aVar3.pMj.mH();
                    return 0;
                case 3:
                    zQ = aVar3.zQ(intValue);
                    size = zQ.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aph.mQl = eoVar;
                    }
                    return 0;
                default:
                    return -1;
