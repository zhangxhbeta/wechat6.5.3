...
public final class vr extends aqx {
    public are mcA;
    public int mye;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            r0 = (r0 + a.a.a.a.dS(2, this.mye)) + a.a.a.a.c(3, 8, this.myf);
            if (this.mcA != null) {
                r0 += a.a.a.a.dU(4, this.mcA.aHr());
            }
            return r0;
        } else if (i == 2) {
            r0 = (byte[]) objArr[0];
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        vrVar.mcA = com_tencent_mm_protocal_c_are;
                    }
                    return 0;
                default:
                    return -1;
