...
public final class awu extends aqx {
    public int miR;
    public are mkF;
    public la mkI;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_awu.mQl = eoVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_awu.mkI = laVar;
                    }
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_awu.miR = aVar3.pMj.mH();
                    return 0;
                case 4:
                    zQ = aVar3.zQ(intValue);
                    size = zQ.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_awu.mkF = com_tencent_mm_protocal_c_are;
                    }
                    return 0;
                default:
                    return -1;
