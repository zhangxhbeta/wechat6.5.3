...
public final class acd extends aqp {
    public int mDi;
    public int mDj;
    public are mDk;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_acd.mPU = enVar;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_acd.mDi = aVar3.pMj.mH();
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_acd.mDj = aVar3.pMj.mH();
                    return 0;
                case 4:
                    zQ = aVar3.zQ(intValue);
                    size = zQ.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_acd.mDk = com_tencent_mm_protocal_c_are;
                    }
                    return 0;
                default:
                    return -1;
