...
public final class js extends aqp {
    public String cUd;
    public String gom;
    public String gon;
    public int mdC;
        ...
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    jsVar.gon = aVar3.pMj.readString();
                    return 0;
                case 3:
                    jsVar.gom = aVar3.pMj.readString();
                    return 0;
                case 4:
                    jsVar.mmc = aVar3.pMj.mI();
                    return 0;
                case 5:
                    jsVar.mjT = aVar3.pMj.readString();
                    return 0;
                case 6:
                    jsVar.mmd = aVar3.pMj.readString();
                    return 0;
                case 7:
                    jsVar.mdC = aVar3.pMj.mH();
                    return 0;
                case 8:
                    jsVar.mme = aVar3.pMj.readString();
                    return 0;
                case 9:
                    jsVar.cUd = aVar3.pMj.readString();
                    return 0;
                default:
                    return -1;
            }
