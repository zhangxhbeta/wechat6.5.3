...
public final class aam extends aqx {
    public bec mng;
    public aoo mni;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (this.mQl == null) {
                ...
                if (this.mng != null) {
                    aVar.dX(2, this.mng.aHr());
                    this.mng.a(aVar);
                }
                if (this.mni == null) {
                    return 0;
                }
                aVar.dX(3, this.mni.aHr());
                this.mni.a(aVar);
                return 0;
            }
        } else if (i == 1) {
            ...
            if (this.mng != null) {
                r0 += a.a.a.a.dU(2, this.mng.aHr());
            }
            if (this.mni != null) {
                r0 += a.a.a.a.dU(3, this.mni.aHr());
            }
            return r0;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aam.mQl = eoVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aam.mng = eoVar;
                    }
                    return 0;
                case 3:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aam.mni = eoVar;
                    }
                    return 0;
                default:
                    return -1;
