...
public final class qm extends a {
    public LinkedList<ql> mtZ = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((a.a.a.c.a) objArr[0]).d(1, 8, this.mtZ);
            return 0;
        } else if (i == 1) {
            return a.a.a.a.c(1, 8, this.mtZ) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = qlVar.a(aVar3, qlVar, a.a(aVar3))) {
                            }
                            qmVar.mtZ.add(qlVar);
                        }
                        return 0;
