...
public final class ata extends aqx {
    public LinkedList<aqy> mRv = new LinkedList();
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return r0 + a.a.a.a.c(2, 8, this.mRv);
        } else if (i == 2) {
            r0 = (byte[]) objArr[0];
            this.mRv.clear();
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_ata.mQl = eoVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_ata.mRv.add(eoVar);
                    }
                    return 0;
                default:
                    return -1;
