...
public final class aak extends aqx {
    public aqr mBR;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            aak com_tencent_mm_protocal_c_aak = (aak) objArr[1];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aak.mQl = eoVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aak.mBR = eoVar;
                    }
                    return 0;
                default:
                    return -1;
