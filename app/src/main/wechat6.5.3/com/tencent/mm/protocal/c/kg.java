...
public final class kg extends aqx {
    public ads mmP;
    public LinkedList<ck> mmQ = new LinkedList();
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return r0 + a.a.a.a.c(3, 8, this.mmQ);
        } else if (i == 2) {
            r0 = (byte[]) objArr[0];
            this.mmQ.clear();
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        kgVar.mmP = com_tencent_mm_protocal_c_ads;
                    }
                    return 0;
                case 3:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        ck ckVar = new ck();
                        aVar4 = new a.a.a.a.a(r0, unknownTagHandler);
                        for (z = true; z; z = ckVar.a(aVar4, ckVar, aqx.a(aVar4))) {
                        }
                        kgVar.mmQ.add(ckVar);
                    }
                    return 0;
