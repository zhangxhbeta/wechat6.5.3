...
public final class cx extends a {
    public LinkedList<cy> mdv = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((a.a.a.c.a) objArr[0]).d(1, 8, this.mdv);
            return 0;
        } else if (i == 1) {
            return a.a.a.a.c(1, 8, this.mdv) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = cyVar.a(aVar3, cyVar, a.a(aVar3))) {
                            }
                            cxVar.mdv.add(cyVar);
                        }
                        return 0;
