...
public final class aen extends aqx {
    public int mER;
    public ads mmP;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return r0 + a.a.a.a.dS(3, this.mER);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aen.mQl = eoVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aen.mmP = com_tencent_mm_protocal_c_ads;
                    }
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_aen.mER = aVar3.pMj.mH();
                    return 0;
                default:
                    return -1;
            }
