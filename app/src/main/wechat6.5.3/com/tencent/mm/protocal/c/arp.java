...
public final class arp extends aqx {
    public String mfZ;
    public ais mga;
    public abt mgm;
    public abu mgn;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (this.mgn != null) {
                r0 += a.a.a.a.dU(3, this.mgn.aHr());
            }
            if (this.mfZ != null) {
                r0 += a.a.a.b.b.a.f(4, this.mfZ);
            }
            if (this.mga != null) {
                r0 += a.a.a.a.dU(5, this.mga.aHr());
            }
            return r0;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_arp.mQl = eoVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_arp.mgm = com_tencent_mm_protocal_c_abt;
                    }
                    return 0;
                case 3:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_arp.mgn = com_tencent_mm_protocal_c_abu;
                    }
                    return 0;
                case 4:
                    com_tencent_mm_protocal_c_arp.mfZ = aVar3.pMj.readString();
                    return 0;
                case 5:
                    zQ = aVar3.zQ(intValue);
                    size = zQ.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_arp.mga = com_tencent_mm_protocal_c_ais;
                    }
                    return 0;
                default:
                    return -1;
