...
public final class dt extends aqp {
    public long eeK;
    public int maG;
    public int meD;
        ...
        if (i == 0) {
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    return 0;
                case 4:
                    dtVar.meF = aVar3.pMj.readString();
                    return 0;
                case 5:
                    dtVar.meG = aVar3.pMj.readString();
                    return 0;
                case 6:
                    dtVar.maG = aVar3.pMj.mH();
                    return 0;
                case 7:
                    dtVar.eeK = aVar3.pMj.mI();
                    return 0;
                case 8:
                    dtVar.meH = aVar3.pMj.readString();
                    return 0;
                case 9:
                    dtVar.meI = aVar3.pMj.readString();
                    return 0;
                default:
                    return -1;
            }
