...
public final class aue extends aqp {
    public int mRL;
    public are meT;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return r0 + a.a.a.a.dS(3, this.mRL);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aue.mPU = enVar;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_aue.meT = com_tencent_mm_protocal_c_are;
                    }
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_aue.mRL = aVar3.pMj.mH();
                    return 0;
                default:
                    return -1;
            }
