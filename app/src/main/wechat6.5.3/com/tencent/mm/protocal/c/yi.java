...
public final class yi extends aqx {
    public int gly;
    public aoi mAg;
    public aog mAh;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (this.mQl == null) {
                ...
                aVar.dV(2, this.gly);
                if (this.mAg != null) {
                    aVar.dX(3, this.mAg.aHr());
                    this.mAg.a(aVar);
                }
                if (this.mAh == null) {
                    return 0;
                }
                aVar.dX(4, this.mAh.aHr());
                this.mAh.a(aVar);
                return 0;
            }
        } else if (i == 1) {
            ...
            if (this.mAg != null) {
                r0 += a.a.a.a.dU(3, this.mAg.aHr());
            }
            if (this.mAh != null) {
                r0 += a.a.a.a.dU(4, this.mAh.aHr());
            }
            return r0;
        } else if (i == 2) {
