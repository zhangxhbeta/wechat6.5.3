...
public final class bfd extends a {
    public int eet;
    public LinkedList<bfc> eeu = new LinkedList();
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (i == 2) {
                ...
                switch (intValue) {
                    case 1:
                        com_tencent_mm_protocal_c_bfd.eet = aVar3.pMj.mH();
                        return 0;
                    case 2:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = com_tencent_mm_protocal_c_bfc.a(aVar4, com_tencent_mm_protocal_c_bfc, a.a(aVar4))) {
                            }
