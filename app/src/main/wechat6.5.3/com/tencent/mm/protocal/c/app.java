...
public final class app extends aqx {
    public api mOR;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            app com_tencent_mm_protocal_c_app = (app) objArr[1];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_app.mOR = com_tencent_mm_protocal_c_api;
                    }
                    return 0;
                case 2:
                    zQ = aVar3.zQ(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_app.mQl = eoVar;
                    }
                    return 0;
                default:
                    return -1;
