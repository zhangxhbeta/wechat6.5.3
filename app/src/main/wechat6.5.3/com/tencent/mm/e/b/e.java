...
public abstract class e extends c {
    ...
    private static final int buA = "createAdTime".hashCode();
    private static final int buB = "exposureTime".hashCode();
    private static final int buC = "firstControlTime".hashCode();
    private static final int buD = "recxml".hashCode();
    ...
    private static final int buy = "adinfo".hashCode();
    private static final int buz = "adxml".hashCode();
