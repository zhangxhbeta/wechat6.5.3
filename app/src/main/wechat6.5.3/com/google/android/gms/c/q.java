...
public class q<K, V> {
    ...
    static void b(int[] iArr, Object[] objArr, int i) {
        int i2;
        if (iArr.length == 8) {
    ...
    public boolean containsKey(Object obj) {
        return obj == null ? bK() >= 0 : indexOf(obj, obj.hashCode()) >= 0;
    }
    ...
    public V get(Object obj) {
        int bK = obj == null ? bK() : indexOf(obj, obj.hashCode());
        return bK >= 0 ? this.vU[(bK << 1) + 1] : null;
    }
